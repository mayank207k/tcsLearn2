                ...
                do
                {
                    switch (choice)
                    {
                        case 1:
                            ...
                            Console.WriteLine("Result of Addition is {0} ", add(A,B));
                            break;
                        ...
                        case 2:
                            ...
                            Console.WriteLine("Enter the second number B:");
                            B = Convert.ToInt32(Console.ReadLine());
                            Console.WriteLine("Result of subtraction is {0} ", subtract(A,B));
                            break;
                        ...
                        case 3:
                            ...
                            Console.WriteLine("Result of multiplication is {0} ", multiply(firstnum,secondnum));
                            break;
